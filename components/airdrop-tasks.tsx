...
export default function AirdropTasks({ walletAddress, walletType }: AirdropTasksProps) {
  ...
  // Valor da taxa em ETH (equivalente a 0.49 USD)
  // Nota: Em um ambiente real, você pode querer usar uma API para obter a taxa de câmbio atual
  const FEE_AMOUNT = "0.00015" // Aproximadamente 0.49 USD em ETH na rede Sepolia
  ...
  const handleClaimTokens = useCallback(async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `Sua carteira será aberta para autorizar o pagamento de ${FEE_AMOUNT} ETH (aprox. $0.49 USD) para reivindicar seus tokens.`,
  ...
  }, [verificationStatus, existingClaim, toast, systemConfig])
        ...
        <div className="space-y-6">
          ...
          <div className="border border-purple-800/30 bg-purple-900/10 rounded-lg p-4">
            ...
            <p className="text-sm text-gray-300 mb-4">
              ...
              pagar uma taxa de {FEE_AMOUNT} ETH (aproximadamente $0.49 USD).
            </p>
              ...
              <div className="bg-blue-900/20 border border-blue-700/30 rounded-lg p-3 mb-4 flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300 mt-1">
                    ...
                    {FEE_AMOUNT} ETH (aproximadamente $0.49 USD) para completar a reivindicação.
                  </p>
