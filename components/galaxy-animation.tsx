// Vamos simplificar significativamente a animação galáctica para melhorar a performance
// Reduzindo o número de elementos e a complexidade das animações
...
export default function GalaxyAnimation() {
  ...
  useEffect(() => {
    ...
    const starCount = isLowPerfMode
      ? Math.floor((window.innerWidth * window.innerHeight) / 10000) // Muito menos estrelas
